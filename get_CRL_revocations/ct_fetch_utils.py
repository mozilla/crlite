...
def processDerData(der_data, crl_outfile, certs_outfile):
...
def processCer(file_path, crl_outfile, certs_outfile):
    ...
    try:
        with open(file_path, 'rb') as f:
            der_data = f.read()
            processDerData(der_data, crl_outfile, certs_outfile)
...
def processCTData(ct_data_path, crl_outfile, certs_outfile, certs_limit):
    counter["Certs Limit"] = certs_limit
